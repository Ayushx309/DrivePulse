...
function mailReceipt($id, $email, $name)
{
    @include 'config.php';
    ...
    if ($result) {
        ...
        if ($row) {
            ...
            // Personal Details global var
            global $name;
            global $phone;
            global $email;
            global $address;

            // Booking Details global var
            global $date;
            global $time;
            global $days;   
            global $Tname;
...
if($_GET['id'] and $_GET['email'] and $_GET['name']){
        mailReceipt($_GET['id'], $_GET['email'],$_GET['name']);
}
...
<body>
    <div class="vert">
        <div class="vertical-text">
            <p style="color: #f5f5f5; filter: drop-shadow(0 0 10px);"><br><span style="color: red">PDF</span> Preview
                <span style="color: red">PDF</span> Preview <span style="color: red">PDF</span>
            </p>
        </div>
    </div>
    <div class="load">
    ...
    <img src="assets/mailPDF.png" class="background-image" style="image-resolution: 1000dpi;">
