...
if (isset($_GET['id'])) {
    ...
    if (!$result) {
        ...
        logActivity('staff_logs', $_SESSION['staff_name'],  array("What" => "Added one day to Customer in timetable", array("customer_details" => array("name" => $name, "phone" => $phone), "changed_things" => array("car" => $_GET['car'], "date" => array("0ld" => $end_date, "new" => $newEndDate)))));
