...
<div class="loader">
    ...
    <p class="pload">Loading</p>
       <p class="pload">Storing</p>
       <p class="pload">Generating</p>
       <p class="pload">Please </p>
       <p class="pload">Arranging</p>
    </div> 
       <div class="words">
...
<!-- <script>
    let features = 'menubar=yes,location=yes,resizable=no,scrollbars=no,staus=no';
